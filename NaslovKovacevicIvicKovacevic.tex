...
Fokus u sprečavanju XSS \cite{XSS_prev} napada se oslanja na problem toga što pretraživač renderuje HTML tagove i izvršava Javascript kod.  
...
Pretpostavimo da ne možemo mi direktno da izbrišemo nalog sa sajta banke (nemamo vidljivo dugme za tu funkcionalnost, već moramo da šaljemo zahtev adminu da to uradi), možemo da pretpostavimo (nagađamo) da i ostale akcije imaju slične nazive (npr. \say{action=obrisiProfil}) i da im na taj način neovlašćeno pristupimo.\\
\end{primer}
